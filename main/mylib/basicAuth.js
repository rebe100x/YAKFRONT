...
//		User.findOne({"apiData.apiClientId":clientid},{}, function(err, userFound) {
  ...
  // send email to user to say that his account has been suspended
  schema.static('sendBlacklistedMail', function ( mail, cb) {
    ...
    var messageSubject = '';
    var headerContent = ''
    var mailTemplate = __dirname+'/../views/mails/accountBlacklisted.html';
    messageSubject = "Désactivation de votre compte"; 
    headerContent = "Votre compte ne respectant pas les régles de la plate-forme Yakwala, il a été désactivé.";
    ...
    fs.readFile(mailTemplate, 'utf8', function(err, data) {
      ...
      var mailOptions = {
        ...
        text: "Bonjour, \r\n Votre compte a été désactivé", // plaintext bod
        html: data
      } 
...
// Send an email to sgnify a user that one of his content has been deleted
  schema.static('sendIlliciteMail', function ( mail, content, cb) {
    ...
    headerContent = "Un de vos contenus a été désactivé";
    var logo = conf.fronturl+"/static/images/yakwala-logo_petit.png";
    ...
    fs.readFile(mailTemplate, 'utf8', function(err, data) {
      ...
      var mailOptions = {
        ...
        to: mail, // list of receivers
        subject: messageSubject, // Subject line
        text: "Bonjour, \r\n Un de vos contenus a été modéré : " + content, // plaintext bod
        html: data
      } 
